...
window.MENU_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "11,95€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Cheddar, Bacon Crocante, Cebola Caramelizada, Tomate, Maionese de Manjericão",
          en: "Burger bun, beef patty with cheddar cheese, crispy bacon, caramelized onion, tomato, basil mayo",
          es: "Pan de hamburguesa, hamburguesa con queso cheddar, bacon crujiente, cebolla caramelizada, tomate, mayonesa de albahaca",
        },
        allergens: null,
      },
      {
        ...
        price: "12,65€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Emmental, Tomate Cherry Assado, Maionese de Barbecue, Cebola Crua, Presunto Frito, Pimentos Vermelhos Assados, Molho Tártaro",
          en: "Burger bun, beef patty with emmental cheese, roasted cherry tomato, barbecue mayo, raw onion, fried cured ham, roasted red peppers, tartar sauce",
          es: "Pan de hamburguesa, hamburguesa con queso emmental, tomate cherry asado, mayonesa de barbacoa, cebolla cruda, jamón curado frito, pimientos rojos asados, salsa tártara",
        },
        allergens: null,
      },
      {
        ...
        price: "11,75€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Gorgonzola, Salame Picante, Cebola Confitada Agridoce, Tomate, Maionese de Alho",
          en: "Burger bun, beef patty with gorgonzola cheese, spicy salami, sweet-and-sour confit onion, tomato, garlic mayo",
          es: "Pan de hamburguesa, hamburguesa con queso gorgonzola, salami picante, cebolla confitada agridulce, tomate, mayonesa de ajo",
        },
        allergens: null,
      },
      {
        ...
        price: "12,65€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Cheddar, Cebola Roxa, Tomate Cherry Assado, Bacon Frito, Sour Cream, Ananás",
          en: "Burger bun, beef patty with cheddar cheese, red onion, roasted cherry tomato, fried bacon, sour cream, pineapple",
          es: "Pan de hamburguesa, hamburguesa con queso cheddar, cebolla morada, tomate cherry asado, bacon frito, sour cream, piña",
        },
        allergens: null,
      },
      {
        ...
        price: "11,85€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Cheddar, Ovo Estrelado, Presunto Frito, Cogumelos, Tomate, Alface, Maionese de Alho",
          en: "Burger bun, beef patty with cheddar cheese, fried egg, fried cured ham, mushrooms, tomato, lettuce, garlic mayo",
          es: "Pan de hamburguesa, hamburguesa con queso cheddar, huevo frito, jamón curado frito, champiñones, tomate, lechuga, mayonesa de ajo",
        },
        allergens: null,
      },
      {
        ...
        price: "10,95€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer de Beterraba, Feijão Preto e Arroz, Queijo Cheddar, Tomate Xuxa, Alface Iceberg, Maionese de Alho",
          en: "Burger bun, beetroot patty, black beans and rice, cheddar cheese, tomato, iceberg lettuce, garlic mayo",
          es: "Pan de hamburguesa, hamburguesa de remolacha, frijoles negros y arroz, queso cheddar, tomate, lechuga iceberg, mayonesa de ajo",
        },
        allergens: null,
      },
      {
        ...
        price: "12,95€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Chouriço de Malagueta, Queijo da Serra, Ovo Estrelado, Cebola Confitada, Agrião, Maionese de Pimentos Vermelhos",
      ...
      },
      {
        ...
        price: "12,55€",
        description: {
          pt: "Pão de Hambúrguer, Hambúrguer com Queijo Emmental, Maionese de Beringela, Couve Roxa, Cebola Roxa Frita, Bacon Frito, Molho Tártaro, Picles",
          en: "Burger bun, beef patty with emmental cheese, eggplant mayo, red cabbage, fried red onion, fried bacon, tartar sauce, pickles",
          es: "Pan de hamburguesa, hamburguesa con queso emmental, mayonesa de berenjena, col morada, cebolla morada frita, bacon frito, salsa tártara, pepinillos",
        },
        allergens: null,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "10,95€",
        description: {
          pt: "Alface, Peito de Frango Grelhado, Croutons, Bacon Crocante, Lascas de Queijo Parmesão",
          en: "Lettuce, grilled chicken breast, croutons, crispy bacon, shaved parmesan",
          es: "Lechuga, pechuga de pollo a la plancha, croutons, bacon crujiente, virutas de queso parmesano",
        },
        allergens: null,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "12,95€",
        description: {
          pt: "Bolo do Caco, Queijo da Ilha, Tomate Cherry Confitado, Ketchup, Maionese de Alho",
          en: "Bolo do Caco bread, Ilha cheese, confit cherry tomato, ketchup, garlic mayo",
          es: "Pan Bolo do Caco, queso da Ilha, tomate cherry confitado, ketchup, mayonesa de ajo",
        },
        allergens: null,
      },
      {
        ...
        price: "10,95€",
        description: {
          pt: "Bolo do Caco, Peito de Frango Grelhado, Bacon Crocante, Alface, Molho Caesar, Queijo Parmesão",
          en: "Bolo do Caco bread, grilled chicken breast, crispy bacon, lettuce, Caesar dressing, parmesan cheese",
          es: "Pan Bolo do Caco, pechuga de pollo a la plancha, bacon crujiente, lechuga, salsa Caesar, queso parmesano",
        },
        allergens: null,
      },
    ],
    ...
    items: [
      {
        ...
        price: "4,85€",
        description: {
          pt: "Tarte Caseira, Chantilly de Limão",
          en: "Homemade tart, lime whipped cream",
          es: "Tarta casera, chantillí de lima",
        },
        allergens: null,
      },
      {
  ...
  },
  {
    ...
    items: [
      { id: "gin-tonico", name: "Gin Tónico", price: "4,00€ / Shot", allergens: null },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "duque-de-viseu", name: "Duque de Viseu", price: "4,70€ / 15,90€", allergens: null },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "fluz-sauvignon-blanc",
        name: "Fluz Sauvignon Blanc",
        price: "4,90€ / 15,90€",
        region: "Lisboa",
        allergens: null,
      },
